                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                        ...
                        <select name="product_label">
                            ...
                            <option value="Limited">Limited Product</option>
                        
                            <option value="Onsale">OnSale Product</option>
                            <option value="InStock">InStock Product</option>
                            <option value="OutofStock">OutOfStock Product</option> 
