        ...
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>Hamro Garden</strong>
                    <br/>Birgunj,Parsa
                    <br/>Nepal
                    <br/>9824289012
                    <br/>9865521235
                    <br/>akashkumarpatel081@gmail.com<br/>dileep823695@gmail.com
                    <br/><strong>Mr.Akash and Mr.Dileep</strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2022 Hamro Garden All Rights Reserve</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">Mr.Akash and Mr.Dileep</a></p>
